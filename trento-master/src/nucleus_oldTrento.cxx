...
NucleusPtr Nucleus::create(const std::string& species, double nucleon_dmin) {
  ...
  //===========
  else if (species == "O") //Farid Added
    return NucleusPtr{new WoodsSaxonNucleusIII{
       16, 2.608, 0.513, -0.051, nucleon_dmin
    }};
  //============
  //===========
  else if (species == "Ar") //Farid Added
    return NucleusPtr{new WoodsSaxonNucleusIII{
       40, 3.73, 0.62, -0.19, nucleon_dmin
    }};
  //============
  else if (species == "Cu")
    ...
    return NucleusPtr{new DeformedWoodsSaxonNucleusII{
       96, 5.09, 0.46, 0.162, 0, 0, nucleon_dmin
    }};
  else if (species == "RuII") ///Farid Added
    return NucleusPtr{new DeformedWoodsSaxonNucleusII{
       96, 5.09, 0.46, 0.06, 0, 0, nucleon_dmin
    }};
  else if (species == "RuIII") ///Farid Added
    return NucleusPtr{new DeformedWoodsSaxonNucleusII{
       96, 5.09, 0.46, 0.06, 0.20, 0, nucleon_dmin
    }};    
    ...
    return NucleusPtr{new DeformedWoodsSaxonNucleusII{
       96, 5.02, 0.52, 0.06, 0.20, 0, nucleon_dmin
    }};
    ///==================
  else if (species == "Xe")
    return NucleusPtr{new WoodsSaxonNucleus{
    ...
    else if (species == "Xe2") //Farid Added
    return NucleusPtr{new DeformedWoodsSaxonNucleus{
...
//  =======  Farid Modified for Three parameter WS  ============
WoodsSaxonNucleusIII::WoodsSaxonNucleusIII(
...
//  ===================== Farid Added ===================
double WoodsSaxonNucleusIII::radius() const {
  return R_ + 3.*a_;
}
// ===================================
...
// Sample Woods-Saxon nucleon positions.
void WoodsSaxonNucleusIII::sample_nucleons_impl() {
  // When placing nucleons with a minimum distance criterion, resample spherical
  // angles until the nucleon is not too close to a previously sampled nucleon,
  // but do not resample radius -- this could modify the Woods-Saxon dist.
