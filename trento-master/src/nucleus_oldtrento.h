...
class WoodsSaxonNucleusIII : public MinDistNucleus {
 public:
  /// ``Nucleus::create()`` sets these parameters for a given species.
  /// \param A number of nucleons
  /// \param R Woods-Saxon radius
  /// \param a Woods-Saxon surface thickness
  /// \param dmin minimum nucleon-nucleon distance (optional, default zero)
  WoodsSaxonNucleusIII(std::size_t A, double R, double a, double w, double dmin = 0);
...
class DeformedWoodsSaxonNucleusII : public MinDistNucleus {
 public:
  /// ``Nucleus::create()`` sets these parameters for a given species.
  /// \param A number of nucleons
  /// \param R Woods-Saxon radius
  ...
  /// \param beta4 Woods-Saxon deformation parameter
  /// \param dmin minimum nucleon-nucleon distance (optional, default zero)
  DeformedWoodsSaxonNucleusII(std::size_t A, double R, double a,
 ...
 private:
  ...
  /// Evaluate the deformed Woods-Saxon distribution.
  double deformed_woods_saxon_distII(double r, double cos_theta) const;
